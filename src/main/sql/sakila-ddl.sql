...
Sakilka for H2 is a port of Sakila for Oracle which is a port of the Sakila example database available for MySQL, which was originally developed by Mike Hillyer of the MySQL AB documentation team.
...
ALTER TABLE film
    ADD CONSTRAINT CHECK_special_features CHECK (special_features is null or
